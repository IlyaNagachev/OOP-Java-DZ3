**Получилось реализовать один метод на два типа Freelancer и Employee, но приходится в коде самому прописывать в методе main какой класс сотрудника выводить и сортировать.
В остальном все вроде работает.**
